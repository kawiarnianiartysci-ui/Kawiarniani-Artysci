  ...
  return (
    <div>
      ...
      <div style={{ position:"relative", width:"100%", height:"clamp(260px, 42vw, 440px)", overflow:"hidden", background:C.selectedBg }}>
        <img src={HERO_PHOTO_DZIECI} alt="Warsztat malarski dla dzieci" style={{ position:"absolute", inset:0, width:"100%", height:"100%", objectFit:"cover", objectPosition:"center 58%", display:"block" }} />
